...
import '../../admin/restriction/restricted_product_model.dart';
...
class _CategoryProductGridState extends State<CategoryProductGrid> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    final activeProducts = widget.products.where((product) {
      final isRestricted = restricted.any((item) => item.productId == product.id);
      return !isRestricted;
    }).toList();
...
class _ProductGridCardState extends State<ProductGridCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => showProductBottomSheet(context, widget.product),
        child: Column(
